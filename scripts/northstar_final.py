...
T = {
 "Outagamie":{"VILLAGE OF GREENVILLE":("A+","PRIMARY. Adjacent Appleton. FLU adopted. 7 sub-areas. Water+wastewater. Ag→residential."),"TOWN OF GRAND CHUTE":("A","Adjacent Appleton. US 41. FLU ag→residential. Sewer/water. Active subdivisions."),"VILLAGE OF HARRISON":("A","East Appleton. US 10. Planned residential. Ag→residential transition."),"VILLAGE OF COMBINED LOCKS":("A-","Adjacent Kaukauna. Fox Cities. Sewer/water. Limited ag."),"VILLAGE OF LITTLE CHUTE":("A-","Fox Cities core. Limited undeveloped. Infill."),"TOWN OF BUCHANAN":("B+","Surrounds Kaukauna. Check FLU ag→residential zones."),"TOWN OF FREEDOM":("B+","SW Appleton. Adjacent city. Ag rezoning potential. Check sewer."),"VILLAGE OF KIMBERLY":("B","Fox Cities core. Mostly built out. Limited ag.")},
 "Brown":{"TOWN OF LEDGEVIEW":("A+","PRIMARY. Fastest growing. Adjacent De Pere. Ag→residential active. FLU expansion."),"VILLAGE OF HOWARD":("A","North Green Bay. Active residential. Ag→subdivisions. Demand."),"VILLAGE OF SUAMICO":("A","North Howard. New subdivisions. Ag converting. Strong demand."),"VILLAGE OF BELLEVUE":("A","East Green Bay. Steady residential. Ag rezoning targets."),"TOWN OF LAWRENCE":("A","Near De Pere. I-41/I-43. Ag high rezoning likelihood."),"VILLAGE OF ASHWAUBENON":("A-","Adjacent Green Bay. I-41. Sewer/water. Mostly developed."),"TOWN OF SCOTT":("B+","Near Howard. Growth along roads. Ag development pressure."),"TOWN OF HUMBOLDT":("B+","East Green Bay. Edge growth. Ag near metro. Check FLU."),"VILLAGE OF ALLOUEZ":("B","Adjacent Green Bay. Built out. Infill only.")},
 "Dane":{"CITY OF VERONA":("A+","PRIMARY. Epic Systems. Massive demand. Ag→residential. FLU expansion."),"CITY OF FITCHBURG":("A","South Madison. Major residential. Sewer/water expanding. Ag converting."),"TOWN OF SUN PRAIRIE":("A","Surrounds city. FLU residential. Ag in growth path."),"TOWN OF WESTPORT":("A","Middleton-Lake Mendota. High pressure. Ag→development."),"TOWN OF SPRINGFIELD":("A-","North Middleton. Edge-of-metro. Ag rezoning potential."),"TOWN OF BURKE":("A-","Madison-Sun Prairie. Growth corridor. Ag conversion likely."),"TOWN OF BLOOMING GROVE":("A-","East Madison. Strong pressure. Limited ag."),"TOWN OF PLEASANT SPRINGS":("B+","South Madison. Edge growth. Check FLU."),"TOWN OF DUNN":("B+","SW edge Fitchburg/Verona. Ag. Check boundaries."),"TOWN OF MONTROSE":("B+","SE Oregon edge. Ag — verify FLU."),"VILLAGE OF OREGON":("B+","SW metro. FLU+sewer. Some ag."),"VILLAGE OF MCFARLAND":("B+","SE Madison. Bedroom. Limited ag."),"VILLAGE OF WAUNAKEE":("B+","NW metro. Strong growth. Check FLU."),"VILLAGE OF DEFOREST":("B+","North metro I-39/90. Expanding. Ag corridor."),"VILLAGE OF WINDSOR":("B+","North metro. Ag — verify plans."),"TOWN OF BRISTOL":("B+","North Sun Prairie. Edge growth. Check comp plan.")},
 "Waukesha":{"VILLAGE OF MENOMONEE FALLS":("A","NE edge Milwaukee. Expansion. Ag→residential. I-94."),"TOWN OF LISBON":("A","Menomonee Falls-Pewaukee. FLU residential. Ag converting."),"TOWN OF GENESEE":("A-","Waukesha/Milwaukee edge. Ag development pressure."),"VILLAGE OF PEWAUKEE":("A-","I-94 corridor. Limited remaining ag."),"VILLAGE OF SUSSEX":("A-","Waukesha-Menomonee Falls. Edge growth."),"TOWN OF WAUKESHA":("B+","Adjacent city. Some ag — check FLU."),"TOWN OF BROOKFIELD":("B","Adjacent cities. Mostly developed."),"VILLAGE OF LANNON":("B","Near Menomonee Falls. Small. Limited.")},
 "Ozaukee":{"VILLAGE OF GRAFTON":("A","I-43 corridor. Ag rezoning potential."),"VILLAGE OF SAUKVILLE":("A","I-43 north. Expansion. Ag available."),"TOWN OF CEDARBURG":("A","Adjacent cities. FLU residential. Ag growth path."),"CITY OF MEQUON":("A-","Milwaukee north shore. Limited undeveloped."),"CITY OF CEDARBURG":("B+","I-43 corridor. Bedroom. Limited ag."),"TOWN OF GRAFTON":("B+","I-43 edge. Ag — check FLU.")},
 "Milwaukee":{"FRANKLIN":("B+","Most greenfield. Undeveloped potential."),"OAK CREEK":("B+","SE edge corridor. Undeveloped.")},
 "Rock":{"BELOIT":("A+","PRIMARY. Adjacent Beloit. IL line. I-39/90 Stateline. Ag→residential."),"JANESVILLE":("A","Surrounds Janesville. FLU residential. Ag→development."),"TURTLE":("A","Southern Beloit. Stateline corridor. Ag growth path."),"HARMONY":("B+","East Janesville. Edge growth. Check FLU."),"CITY OF EVANSVILLE":("B+","North metro. Bedroom. Some ag."),"MILTON":("B+","Near Milton City. Edge. Ag parcels."),"FULTON":("B+","NE Janesville. Ag edge potential.")},
 "Winnebago":{"TOWN OF NEENAH":("A","Adjacent Neenah/Menasha. US 41. FLU residential. Ag→development."),"TOWN OF OSHKOSH":("A","South Oshkosh. US 41. Ag rezoning potential."),"TOWN OF ALGOMA":("A","North Oshkosh. US 41. Ag growth path."),"TOWN OF MENASHA":("A-","Surrounds Menasha. Edge growth. Limited ag."),"TOWN OF VINLAND":("B+","North Neenah. Edge. Ag — verify FLU."),"TOWN OF CLAYTON":("B+","SW Neenah. Some growth. Ag."),"VILLAGE OF FOX CROSSING":("B","Neenah-Menasha. Limited ag.")},
 "Calumet":{"TOWN OF HARRISON":("A","South Appleton. US 41/10. Ag strong rezoning."),"TOWN OF MENASHA":("A","Adjacent Menasha/Appleton. Fox Cities edge. Ag→development."),"TOWN OF STOCKBRIDGE":("B+","Lake Winnebago. Ag. Seasonal+year-round."),"TOWN OF BROTHERTOWN":("B+","Lakeshore. Ag. Seasonal+year-round.")},
 "Door":{"VILLAGE OF SISTER BAY":("B","Tourism. Seasonal. Limited ag→subdivision.")},
}
